"""S3 선물 이미지를 공통 마음데이터로 변환하는 작업."""

import asyncio

from app.schemas.agent import HeartData


class ImageAnalysisService:
    """이미지 분석 담당자가 실제 구현으로 교체할 서비스."""

    async def analyze(self, image_url: str) -> HeartData:
