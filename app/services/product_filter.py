...
SYSTEM_PROMPT = (
    ...
    "[꽃·식물] 나주배 세트, [생활용품] 학습 교재처럼 라벨과 물건이 어긋나면 제외한다.\n"
...
#
# 프롬프트의 라벨만 "[꽃·식물]" 로 바꿨습니다. 카테고리를 백엔드 목록에 맞추면서
# 커피·차가 디저트에 접혔고, 그러면 같은 나주배 세트가 **정상 통과**가 되어 예시가
# 반대 교훈을 가르칩니다. 실측 기록은 위에 그대로 두고 예시 라벨만 옮깁니다.
